...
/**
 * HMAC-SHA256 канона USER_UPDATED. Дубликат {@code dn.marketplace.account.config.UserUpdatedEventMac}:
 * SPI не зависит от Spring/монолита. Канон и секрет должны совпадать.
 */
